...
class MainWidget(QWidget):
    def __init__(self, reader: Reader) -> None:
        ...
        self.help_menu.addAction("About", lambda: show_message_box("About",
                                                                   ...
                                                                   "<br><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc3-62/'>EL-UHF-RC3-62-S</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc3-62/'>EL-UHF-RC3-62-U</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc3-91/'>EL-UHF-RC3-91-S</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc3-91/'>EL-UHF-RC3-91-U</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc3-a1/'>EL-UHF-RC3-A1-S</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc3-a1/'>EL-UHF-RC3-A1-U</a><br>"
                                                                   "<br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc4-2/'>EL-UHF-RC4-2 Std</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc4-2/'>EL-UHF-RC4-2 TCP/IP</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc4-62/'>EL-UHF-RC4-62-T</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc4-91/'>EL-UHF-RC4-91-T</a><br>"
                                                                   "- <a href='https://www.electron.id/product/el-uhf-rc4-c1/'>EL-UHF-RC4-C1-T</a><br>"
                                                                   "<br>"
                                                                   "Please contact <a "
